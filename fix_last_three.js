...
const filesToProcess = [
    { file: 'simplissime.jpg', text: 'S I M P L I S S I M E', eraseTop: true, extraSmall: true },
    { file: 'rafraichissements.jpg', text: 'R A F R A Î C H I S S E M E N T S', eraseTop: true, extraExtraSmall: true },
    { file: 'dolce-vita.jpg', text: 'D O L C E   V I T A', eraseTop: true, small: true }
];
...
async function processImages() {
    for (const item of filesToProcess) {
        ...
        const outputPath = path.join(themesDir, 'fixed_last_' + item.file);
        ...
        try {
            ...
            if (item.small) fontSizeRatio = 0.06;
            if (item.extraSmall) fontSizeRatio = 0.045;
            if (item.extraExtraSmall) fontSizeRatio = 0.035;
