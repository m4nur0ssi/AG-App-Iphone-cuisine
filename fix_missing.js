...
const filesToProcess = [
    { file: 'simplissime.jpg', lines: ['SIMPLISSIME'], fontSize: 75, letterSpacing: 25, lighten: false },
    { file: 'rafraichissements.jpg', lines: ["C'EST", 'FRAIS'], fontSize: 75, letterSpacing: 30, lighten: false },
    { file: 'dolce-vita.jpg', lines: ['DOLCE', 'VITA'], fontSize: 75, letterSpacing: 30, lighten: false },
    { file: 'voila-lete.jpg', lines: ['VOILÀ', "L'ÉTÉ"], fontSize: 75, letterSpacing: 30, lighten: false }
];
...
async function processImages() {
    for (const item of filesToProcess) {
        ...
        try {
            ...
            // Draw the base bandeau (this explicitly hides ANY old text underneath!)
