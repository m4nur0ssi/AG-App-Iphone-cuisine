...
const filesToProcess = [
    // Noel wasn't processed previously, so it still had the huge spacing
    { file: 'noel.jpg', lines: ['NOËL'], fontSize: 60, letterSpacing: 15, lighten: false },
    // Simplissime spacing was too small
    { file: 'simplissime.jpg', lines: ['SIMPLISSIME'], fontSize: 50, letterSpacing: 15, lighten: false }
];
...
async function processImages() {
    for (const item of filesToProcess) {
        ...
        const outputPath = path.join(themesDir, 'final3_' + item.file);
