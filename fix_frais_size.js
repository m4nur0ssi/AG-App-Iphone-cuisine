...
async function processImages() {
    for (const item of filesToProcess) {
        ...
        const outputPath = path.join(themesDir, 'fixed_frais_v2_' + item.file);
        ...
        try {
            ...
            // Text configuration - make it very small to fit!
            const fontSizeRatio = 0.040; 
            ...
            console.log(`Processed ${item.file} with new smaller text`);
