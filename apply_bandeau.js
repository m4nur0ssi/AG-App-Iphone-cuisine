...
const filesToProcess = [
    // Reduced font sizes and letter spacing
    { file: 'paques.jpg', lines: ['PÂQUES'], fontSize: 75, letterSpacing: 25, lighten: false },
    { file: 'glaces.jpg', lines: ['GLACES'], fontSize: 75, letterSpacing: 30, lighten: false }, // Already good
    { file: 'cest-lhiver.jpg', lines: ["C'EST", "L'HIVER"], fontSize: 75, letterSpacing: 25, lighten: false },
    { file: 'astuces.jpg', lines: ['ASTUCES'], fontSize: 75, letterSpacing: 25, lighten: true },
    { file: 'sauces.png', lines: ['SAUCES'], fontSize: 75, letterSpacing: 30, lighten: true },
    { file: 'healthy.png', lines: ['HEALTHY'], fontSize: 75, letterSpacing: 25, lighten: true },
    { file: 'airfryer.png', lines: ['AIRFRYER'], fontSize: 75, letterSpacing: 25, lighten: true },
    { file: 'barbecue.png', lines: ['BARBECUE'], fontSize: 75, letterSpacing: 25, lighten: true },
    { file: 'express.png', lines: ['EXPRESS'], fontSize: 75, letterSpacing: 25, lighten: true },
    { file: 'famille.png', lines: ['FAMILLE'], fontSize: 75, letterSpacing: 25, lighten: true },
    { file: 'vegetarien.png', lines: ['VÉGÉTARIEN'], fontSize: 60, letterSpacing: 15, lighten: true },
];
...
async function processImages() {
    for (const item of filesToProcess) {
        ...
        const outputPath = path.join(themesDir, 'final_' + item.file);
        ...
        try {
            ...
            // Make it slightly lighter if requested, so it looks like a distinct bandeau
            if (item.lighten) {
                const lightenRect = `
                    <svg width="${width}" height="${height}">
                ...
                // Just add the subtle line at the bottom to define the bandeau
                const lineRect = `
                    <svg width="${width}" height="${height}">
            ...
            // 2. Add the text with reduced font size and letter spacing
            let textContent = '';
            ...
            // Centered vertically in the bandeau (15% is the middle of 30%)
            const svgText = `
              <svg width="${width}" height="${height}">
                <defs>
