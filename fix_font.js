...
const filesToProcess = [
    ...
    { file: 'noel.jpg', lines: ['NOËL'], fontSize: 60, letterSpacing: 15, lighten: false }
];

// Police moderne, premium et minimaliste (très utilisée dans les apps modernes)
const FONT_FAMILY = "'Avenir Next', 'Avenir', 'Futura', sans-serif";

// Alternative si tu veux un style "Magazine de mode/Luxe" :
// const FONT_FAMILY = "'Didot', 'Bodoni 72', serif";
...
async function processImages() {
    for (const item of filesToProcess) {
        ...
        const outputPath = path.join(themesDir, 'final_font_' + item.file);
        ...
        try {
            ...
            console.log(`✅ Processed ${item.file} with font ${FONT_FAMILY}`);
