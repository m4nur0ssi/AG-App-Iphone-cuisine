...
const filesToProcess = [
    { file: 'vegetarien.png', text: 'V É G É', eraseTop: true }
];
...
async function processImages() {
    for (const item of filesToProcess) {
        ...
        const outputPath = path.join(themesDir, 'fixed_vege_' + item.file);
        ...
        try {
            ...
            console.log(`Processed ${item.file} with text VÉGÉ`);
